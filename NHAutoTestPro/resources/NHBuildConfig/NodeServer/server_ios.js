...
var cmd = 'echo $infoPlistPath && b=$(/usr/libexec/PlistBuddy -c "Print CFBundleVersion" "$HOME/Desktop/mihua/mihua/mihua-Info.plist") && b=$(($b + 1)) && /usr/libexec/PlistBuddy -c "Set :CFBundleVersion $b" "$HOME/Desktop/mihua/mihua/mihua-Info.plist"'
