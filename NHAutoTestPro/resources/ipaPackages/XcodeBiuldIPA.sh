...
declare -x DESTPATH='/Users/nanhujiaju/Desktop/gscj/'
...
xcodebuild clean
xcodebuild -workspace $SCHEME.xcworkspace -scheme $SCHEME -archivePath build/$SCHEME.xcarchive archive
...
xcodebuild clean
xcodebuild -scheme $SCHEME -archivePath build/$SCHEME.xcarchive archive
